...
- **No AaaS credentials**. Sending still works, because that writes to the sender's own eVault. Nothing arrives from other platforms until an administrator configures the service under Settings → Administration → Security.
